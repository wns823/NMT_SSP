...
from fairseq.models.transformer import TransformerEncoder, TransformerDecoder, Embedding, Linear


@register_model("transformer_cbert")
class TransformercBERTModel(FairseqEncoderDecoderModel):
    """
    Args:
    ...
    def build_model(cls, args, task):
        ...
        transformer_cbert_architecture(args)
...
@register_model_architecture("transformer_cbert", "transformer_cbert")
def transformer_cbert_architecture(args):
